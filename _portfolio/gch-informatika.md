...
excerpt: '<div style="display: flex; align-items: center; gap: 20px;">
  <div style="order: 1;">
    <img src="https://dominiksimon.com/images/project1.png" style="width: 160px; height: auto; border: 2px solid lightgray; border-radius: 8px; display: block;">
  </div>
  <div style="flex: 1; font-size: 1rem; line-height: 1.6; order: 2;">
    Repozitář obsahuje výukové lekce pro programování v C++ zaměřené na konzolové aplikace. Každá lekce obsahuje příklady kódu a úkoly.
  </div></div>'
